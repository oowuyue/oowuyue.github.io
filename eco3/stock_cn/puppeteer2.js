...
(async () => {
    ...
    function formatAndSave(value) {
        ...
        if (value.name == "ashares-congestion") {
    ...
    // await taskMacromicroPage("cn_trade", "https://sc.macromicro.me/collections/27/cn-trade-finance-relative/276/cn-china-trade-balance", "/charts/data/276")
    ...
    Promise.all(
      [
        ...
        taskPage("ashares-congestion", "https://legulegu.com/stockdata/ashares-congestion", "ashares-congestion?token")
      ]).then((values) => {
