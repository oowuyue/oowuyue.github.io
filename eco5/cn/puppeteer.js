...
(async () => {
    ...
    //         let dataName = "恐贪指数"
    //         let dataValue = {
    //             date: values.resdata.data.xAxis.categories,
    //             data: values.resdata.data.series[0].data
    //         }
    //         dataValue = dataValue.date.map((item, index) => {
    //             return [item, parseFloat(dataValue.data[index])]
    //         })
