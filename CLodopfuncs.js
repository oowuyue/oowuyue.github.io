(function (win) {
        ...
        VERSION:"6.5.6.6",IVERSION:"6566",CVERSION:"6.5.6.6",HTTPS_STATUS:0,VERSION_EXT:true,
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt.onopen = function(e) {
                                            setTimeout(()=>{ CLODOP.SocketOpened= true;  CLODOP.blPreHttpPost = false; }, 9000);
