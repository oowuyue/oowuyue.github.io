...
function backTest2(dataName, dayDatas) {
    ...
    function mylog(currentDayList, currentWeekList, currentMonthList, cond1) {
    ...
    for (var currentDayIndex = 50; currentDayIndex < dayDatas.length; currentDayIndex++) {
        ...
        if (lastResult) {
            if ((conditon1.length == 0)
                || currentDayIndex - (conditon1[conditon1.length - 1].atIndex) > 10
            ) {
                currentDay.atIndex = currentDayIndex
                currentDay.fucked = false
                conditon1.push(currentDay) // 满足conditon1且隔10天以上
                //mylog(currentDayList, currentWeekList, currentMonthList, currentDay)
            }
        }

        if (conditon1.length > 0
            && conditon1[conditon1.length - 1].fucked === false
            && currentDayIndex - (conditon1[conditon1.length - 1].atIndex) <= 32  //32天内 trick.....
        ) {
            ...
            if (
                ...
                console.log("绿空绿")
                cond2 = true
                //菜油连续  2013-10-10 2013-10-22
                //PVC连续   2014-02-07  2014-03-04    2014-03-12 2014-04-18 绿绿绿
                //棕榈油连续2013-05-06  2013-06-21 绿绿绿
            }
            ...
            if (cond2) {
                ...
                mylog(currentDayList, currentWeekList, currentMonthList, cond1)
            }
        }
